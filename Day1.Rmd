...
2. Load the library(libraries) when you need to activate the feature(s) for your R projects/codes.  Use **library()** function to activate package. (This is required every time you need the package(s)).
...
Choose: **Reference : Packages** Explore built-in data sets
