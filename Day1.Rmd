...
When you execute code within the notebook, the results appear beneath the codes. It's an experience of coding environment and descriptive notes TWO-in-ONE.
...
[rstudio lession 1](https://rmarkdown.rstudio.com/lesson-1.html)
...
When you do wrangling, you usually want to replace the old data set to save up meomory consumption.
