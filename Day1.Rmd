...
Workflow is the preferred steps by steps activity to complete a task.
Some common steps in data science include: exploring data; wrangling data, visualizing data and modeling. 
These tasks are not linear.  Company or team might have very different steps for the sake of productivity and effciency.
These steps are quite commonly iterative too.
...
Data Wrangling is an **iteractive process** to fix or convert the your data to fit your data analysis needs.
It has many names.  Someone calls it data tidying or data cleansing.
