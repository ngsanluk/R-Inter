...
Avoid using the coding pattern like above.  Instead, use piping like below to improve the readability.
You can use filter() function to include selective rows in your result data set.
You can use select() function to make a selective subset of columns.  select() is also widely use for re-arranging the column orders.
...
```{r}
iris %>% 
  select(Petal.Length:Species) # selection starts at 'Patel.Length' column, all they way to 'Species' column
```
