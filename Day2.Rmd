...
Each combination of these two varaibles' value are used to produce to a sub plot.
...
y = a1 + x * a2
x and y are the variable from dataset
...
Here, we use **runinf()** to generate a random uniform distributed number
