...
We usually name the plot by the type of geom that we use to represent data.
...
**Note**: 
You might have to repetitively run a few times before you can see the visualized random model represented by a orange straight line.
```{r}
model = tibble(
...
An execellent ebook for R Data Science
